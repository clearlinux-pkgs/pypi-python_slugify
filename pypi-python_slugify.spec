...
Source0  : https://files.pythonhosted.org/packages/49/3b/492affa71ccdeaadce1a6fba17e12fec301820b19b8cd7220d849686f8ec/python-slugify-8.0.0.tar.gz
...
%prep
%setup -q -n python-slugify-8.0.0
cd %{_builddir}/python-slugify-8.0.0
pushd ..
cp -a python-slugify-8.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674943957
