...
Source0  : https://files.pythonhosted.org/packages/6a/29/fb7f28cb6c0ee3cfef1e2b02f42678aafd179ac9f41833159f2f80fc7f25/python-slugify-6.1.1.tar.gz
...
%prep
%setup -q -n python-slugify-6.1.1
cd %{_builddir}/python-slugify-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645917858
...
cp %{_builddir}/python-slugify-6.1.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-python_slugify/39348c15454a917e7a44ef76017b198dc3834d8d
