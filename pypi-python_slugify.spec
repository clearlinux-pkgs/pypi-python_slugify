...
Source0  : https://files.pythonhosted.org/packages/7c/d3/8e523f41fc3f8d3cc58d2284bb49c1961caefc1a434599ff410ddde38f82/python-slugify-7.0.0.tar.gz
...
%prep
%setup -q -n python-slugify-7.0.0
cd %{_builddir}/python-slugify-7.0.0
pushd ..
cp -a python-slugify-7.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669054851
